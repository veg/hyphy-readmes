...
This repository contains documentation and supporting information for various HyPhy analyses. 
...
The repository is organized by analysis type (e.g., `busted-ph/`). Each directory may contain:
